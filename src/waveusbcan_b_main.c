...
#define WUC_CMD_INIT           0x01
#define WUC_CMD_START          0x02
#define WUC_CMD_STOP           0x03
#define WUC_CMD_CLEAR_RX       0x05
#define WUC_CMD_MSG_STATUS     0x0a
#define WUC_CMD_CAN_STATUS     0x0b
